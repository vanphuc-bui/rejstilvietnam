...
export const editorialVisuals = {
  ...
  hanoi: {
    ...
    oldQuarter: img('Hanoi old quarter (7354080248).jpg','Gadeliv i Hanois Old Quarter','Old Quarter fungerer bedst til fods, med plads til mad og små omveje.','Francisco Anzola / Wikimedia Commons'),
    temple: img('Hanoi - Temple of Literature - 1.jpg','Litteraturtemplet i Hanoi','Litteraturtemplet passer naturligt ind i en historiedag vest for centrum.','Benjamin Smith / Wikimedia Commons'),
