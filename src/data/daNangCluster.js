...
export const daNangPages = {
  ...
  'ba-na-hills': {
    ...
    commercialCta:{eyebrow:'Ba Na Hills',title:'Vil du booke transport og adgang samlet?',text:'Sammenlign ture efter pickup, om kabelbane/entré er inkluderet, starttid og hvor meget fri tid du får ved Golden Bridge.',href:'https://gyg.me/kjVBYhr2',label:'Se Ba Na Hills-ture →',provider:'GetYourGuide'},
    sections:[
