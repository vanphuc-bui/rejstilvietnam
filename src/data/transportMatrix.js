...
export const transportMatrix = [
  ...
  {
    from:'Sapa', to:'Ninh Binh', key:'sapa-ninh-binh', bidirectional:true,
    mode:'Bus / limousine via Hanoi', modeIcon:'🚌', duration:'7 t 30 min–9 t', minutes:495,
    priceMin:500000, priceMax:850000, priceBasis:'pr. person',
    best:'Regn som transportdag', comfort:2, hassle:3,
    note:'Der findes direkte turistforbindelser på udvalgte afgange; ellers skifter du typisk i Hanoi.',
    source:'Operator market range',
  },
  {
    from:'Ninh Binh', to:'Hoi An', key:'ninh-binh-hoi-an', bidirectional:true,
    mode:'Limousine + fly via Hanoi/Da Nang', modeIcon:'✈️', duration:'ca. 6–7 t samlet', minutes:390,
    priceMin:1200000, priceMax:2200000, priceBasis:'pr. person',
    best:'Flyv hvis ferien er kort', comfort:3, hassle:3,
    note:'Alternativet er nattog mod Da Nang og derefter bil til Hoi An; billigere, men markant langsommere.',
    source:'Vietnam Airlines + local transfer range',
  },
  {
    from:'Ha Long Bay', to:'Hoi An', key:'ha-long-hoi-an', bidirectional:true,
    mode:'Shuttle + fly via Hanoi/Da Nang', modeIcon:'✈️', duration:'ca. 6–7 t 30 min samlet', minutes:420,
    priceMin:1300000, priceMax:2400000, priceBasis:'pr. person',
    best:'Planlæg som transportdag', comfort:3, hassle:3,
    note:'Den praktiske kæde er havn → Hanoi/Noi Bai → Da Nang → Hoi An. Læg buffer mellem cruise og fly.',
    source:'Vietnam Airlines + cruise transfer range',
  },
  {
  ...
  {
    from:'Hoi An', to:'Da Lat', key:'hoi-an-da-lat', bidirectional:true,
    mode:'Bus / privat bil', modeIcon:'🚌', duration:'6–8 t', minutes:420,
    priceMin:350000, priceMax:650000, priceBasis:'pr. person / delt transfer',
    best:'Lang overland-dag', comfort:2, hassle:2,
    note:'Et fly kan være hurtigere på enkelte datoer, men frekvensen varierer; bus er den mere forudsigelige løsning.',
    source:'Operator market range',
  },
  {
  ...
  {
    from:'Mekong Delta', to:'Phu Quoc', key:'mekong-phu-quoc', bidirectional:true,
    mode:'Transfer + fly/færge', modeIcon:'🛥️', duration:'ca. 5–8 t afhængigt af base', minutes:390,
    priceMin:600000, priceMax:1500000, priceBasis:'pr. person',
    best:'Planlæg som transporthalvdag', comfort:2, hassle:3,
    note:'Fra Can Tho/Rach Gia kan ruten være mere direkte; fra Ben Tre/My Tho går du ofte tilbage mod Ho Chi Minh City først.',
    source:'Regional transfer/ferry market range',
  },
  {
